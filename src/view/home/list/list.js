...
import './list.css';
export default function List({data ,deleteItm}){
    const {text} = data;
...
<Form.Control type="text" placeholder="Enter a Text" value={taskValue} className=""  disabled = {task.disabled} onChange = {onChangeText} />
 </s>
 </Col>
